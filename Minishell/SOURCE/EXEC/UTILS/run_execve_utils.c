...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/10 11:26:13 by tamadan           #+#    #+#             */
/*   Updated: 2024/01/10 11:26:14 by tamadan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	search_path(t_env_l *env_l, char *str)
{
	...
	while (temp_env)
	{
		if (!ourstrcmp(temp_env->name, str))
		{
			if (!ourstrcmp(temp_env->name, "PWD"))
...
char	*put_command(t_prime *g_prime, t_parser *pars)
{
	char	**path;
	int		i;
	char	*command;
